			...
			<div id="listeQuestion" >
				...
				<div class="question">
					...
					<div class="left detailquest">
						...
						<div class="right">
							<?php 
								//if ($question['rep.dateModified']) {
								//	$action = "répondue";
								//	$temps = dateFr($question['rep.dateModified'])
								//}
								...
								//echo $action . " - " . $temps . " - ";
							?> 
							<!-- <a href="?page=profil&amp;id=< ?= $question['user_id']; ?>" class="lienProfil">< ?php echo $question["pseudo"];?></a> -->
							<!-- < ?= $question['utilisateur.score']; ?> -->
						</div>
